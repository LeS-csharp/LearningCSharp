...
| :--- | :--- | :--- | :--- | :--- |
| 1 | **Калькулятор** | Консольный калькулятор с историей операций | C#, консоль | ✅ Завершен |
| 2 | **Телефонная книга (консоль)** | Добавление, удаление, поиск контактов | C#, List<T>, LINQ | ⏳ В процессе |
